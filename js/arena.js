...
Sherwood.ArenaUI = {
    ...
    _showArenaBattle: function() {
        ...
        Sherwood.CombatUI._showBattleScreen(
            ...
            'Арена - ' + opp.name,
            '',
            'Sherwood.ArenaUI._attack()',
            'Sherwood.ArenaUI._flee()',
            'assets/backgrounds/duel_arena.png'
        );
    ...
    _switchTarget: function() {
        ...
        if (nextIdx !== currentIdx) {
            ...
            this._showArenaBattle();
            Sherwood.CombatUI._showDialog('Цель переключена', '#ff9800');
        }
    },
    ...
    _attack: function() {
        ...
        if (result.error) {
            Sherwood.CombatUI._showDialog(result.error, '#ff9800');
            return;
        }
